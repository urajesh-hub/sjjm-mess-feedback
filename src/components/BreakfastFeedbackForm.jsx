...
const BreakfastFeedbackForm = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await addDoc(collection(db, 'breakfastFeedback'), { ...formData, date: new Date(formData.date) });
        ...
        <div className="card-body">
          <form onSubmit={handleSubmit}>
            ...
            <img src="/images/main_dish.jpg" alt="Main Dish" className="card-img-top" />
              <div className="card-body">
                <label className="form-label"><strong>5. நீங்கள் சாப்பிட்ட காலை உணவு ?</strong> </label>
            ...
            <img src="/images/rating.jpg" alt="Side Dish Rating" className="card-img-top" />
              <div className="card-body">
                <label className="form-label"><strong>6. காலை உணவின்  சுவை ( ஆப்பம்,  பூரி, தோசை,கோதுமை தோசை, இட்லி, வெண் பொங்கல்) எவ்வாறு இருந்தது? </strong></label>
            ...
            <img src="/images/side_dish.jpg" alt="Side Dish" className="card-img-top" />
              <div className="card-body">
                <label className="form-label"><strong>7. காலை உணவின் பக்க உணவு ?</strong></label>
            ...
            <img src="/images/rating.jpg" alt="Side Dish Rating" className="card-img-top" />
              <div className="card-body">
                <label className="form-label"><strong>8. பக்க  உணவின்  சுவை (தேங்காய் பால், சாம்பார், குருமா, தக்காளி சட்னி, தேங்காய் சட்னி) எவ்வாறு இருந்தது?</strong></label>
                <div className="star-rating">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <span
                      key={star}
            ...
            <div className="card mb-3">
              <div className="card-body">
                <label htmlFor="sideDishComment" className="form-label"><strong>10. Side Dish Comment - Any specific feedback on the taste of the side dish (coconut milk, sambar, kuruma, tomato chutney, coconut chutney)?</strong></label>
                <p> பக்க உணவின்  சுவையைப் பற்றி  (தேங்காய் பால், சாம்பார், குருமா, தக்காளி சட்னி, தேங்காய் சட்னி)  ஏதேனும் குறிப்பிட்ட கருத்து உள்ளதா?</p>
                <textarea
                  className="form-control"
                  id="sideDishComment"
